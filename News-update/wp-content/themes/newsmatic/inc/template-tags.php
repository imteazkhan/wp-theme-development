...
function newsmatic_custom_word_count_russian($text) {
    // Match Russian words using a regular expression
    $matches = preg_match_all('/\b\p{Cyrillic}+\b/u', $text, $wordMatches);
    ...
    // Return the count of matched Russian words
    return $matches;
}
