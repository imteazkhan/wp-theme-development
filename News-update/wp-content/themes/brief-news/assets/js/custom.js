jQuery(function ($) {
    ...
    /* -----------------------------------------
      Scroll To Top
      ----------------------------------------- */
    var brief_news_scroll_btn = $(".scroll-to-top");

    $(window).scroll(function () {
        if ($(window).scrollTop() > 400) {
            brief_news_scroll_btn.addClass("show");
        } else {
            brief_news_scroll_btn.removeClass("show");
        }
    });

    brief_news_scroll_btn.on("click", function (e) {
        e.preventDefault();
        $("html, body").animate(
        {
            scrollTop: 0,
