 ...
 * Dynamic CSS
 */
function brief_news_dynamic_css() {

	$site_title_font       = get_theme_mod( 'brief_news_site_title_font', 'Commissioner' );
	$site_description_font = get_theme_mod( 'brief_news_site_description_font', 'Poppins' );
	$header_font           = get_theme_mod( 'brief_news_header_font', 'Inter' );
	$body_font             = get_theme_mod( 'brief_news_body_font', 'Poppins' );
	...
	wp_add_inline_style( 'brief-news-style', $custom_css );

}

add_action( 'wp_enqueue_scripts', 'brief_news_dynamic_css', 99 );
