<?php
if ( ! class_exists( 'Brief_News_Grid_List_Posts_Widget' ) ) {
	/**
	 * Adds Brief_News_Grid_List_Posts_Widget Widget.
	 */
	class Brief_News_Grid_List_Posts_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$brief_news_grid_list_posts_widget_ops = array(
				'classname'   => 'grid-list-posts ascendoor-widget style-1',
				'description' => __( 'Retrive Grid List Posts Widgets', 'brief-news' ),
			);
			parent::__construct(
				'brief_news_grid_list_posts_widget',
				__( 'Ascendoor Grid List Posts Widget', 'brief-news' ),
				$brief_news_grid_list_posts_widget_ops
			);
		}
