<?php
if ( ! class_exists( 'Brief_News_Tile_Posts_Widget' ) ) {
	/**
	 * Adds Brief_News_Tile_Posts_Widget Widget.
	 */
	class Brief_News_Tile_Posts_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$brief_news_tile_posts_widget_ops = array(
				'classname'   => 'tile-posts ascendoor-widget style-1',
				'description' => __( 'Retrive Tile Posts Widgets', 'brief-news' ),
			);
			parent::__construct(
				'brief_news_tile_posts_widget',
				__( 'Ascendoor Tile Posts Widget', 'brief-news' ),
				$brief_news_tile_posts_widget_ops
			);
		}
